...
Use **Settings → Backup & Restore** and avoid mapping the entire `/a0` directory. See [How to update Agent Zero Lite](../setup/installation.md#how-to-update-agent-zero-lite).

**8. How do I use browser automation in Agent Zero Lite?**
Lite removes the built-in browser agent and Playwright runtime. Use MCP alternatives such as Browser OS, Chrome DevTools MCP, or Playwright MCP. See [MCP Setup](mcp-setup.md).
